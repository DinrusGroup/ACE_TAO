...
#ifndef _TAO_IDL_CCM_HOMES_5RYD5N_H_
#define _TAO_IDL_CCM_HOMES_5RYD5N_H_

#include /**/ "ace/pre.h"

#include "CCM_HomeC.h"
#include "ccm/CCM_ExceptionsS.h"
...
#if !defined (_COMPONENTS_CCMOBJECT__SARG_TRAITS_)
#define _COMPONENTS_CCMOBJECT__SARG_TRAITS_

  template<>
  class  SArg_Traits< ::Components::CCMObject>
    : public
...
#if !defined (_COMPONENTS_CCMHOME__SARG_TRAITS_)
#define _COMPONENTS_CCMHOME__SARG_TRAITS_

  template<>
  class  SArg_Traits< ::Components::CCMHome>
    : public
        Object_SArg_Traits_T<
...
namespace POA_Components
{
  ...
  public:
    ...
    virtual void remove_component (
      ::Components::CCMObject_ptr comp) = 0;
