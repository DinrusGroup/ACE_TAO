...
#ifndef _TAO_IDL_CCM_NAVIGATIONS_CSQZOG_H_
#define _TAO_IDL_CCM_NAVIGATIONS_CSQZOG_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::Components::NameList>
    : public
...
#if !defined (_COMPONENTS_NAVIGATION__SARG_TRAITS_)
#define _COMPONENTS_NAVIGATION__SARG_TRAITS_

  template<>
  class  SArg_Traits< ::Components::Navigation>
    : public
...
namespace POA_Components
{
  ...
  class CCM_SVNT_Export Navigation
  ...
  public:
    ...
    typedef ::Components::Navigation_ptr _stub_ptr_type;
    typedef ::Components::Navigation_var _stub_var_type;
    ...
    ::Components::Navigation *_this (void);
