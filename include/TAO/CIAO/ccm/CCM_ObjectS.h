...
#ifndef _TAO_IDL_CCM_OBJECTS_J8BSD9_H_
#define _TAO_IDL_CCM_OBJECTS_J8BSD9_H_
...
#include "ccm/CCM_PrimaryKeyBaseS.h"
...
#define _COMPONENTS_CCMOBJECT__SARG_TRAITS_
  ...
  template<>
  class SArg_Traits< ::Components::CCMObjectSeq>
    : public
...
namespace POA_Components
{
  ...
  class CCM_SVNT_Export CCMObject
